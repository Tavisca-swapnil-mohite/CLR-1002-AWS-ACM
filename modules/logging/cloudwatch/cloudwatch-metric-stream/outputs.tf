output "cloudwatch_metric_stream" {
  ...
  value       = try(aws_cloudwatch_metric_stream.this.arn, "")
}
...
output "cloudwatch_metric_stream_creation_date" {
  ...
  value       = try(aws_cloudwatch_metric_stream.this.creation_date, "")
}
